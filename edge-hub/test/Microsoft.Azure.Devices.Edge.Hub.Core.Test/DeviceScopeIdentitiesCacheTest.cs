...
namespace Microsoft.Azure.Devices.Edge.Hub.Core.Test
{
    ...
    public class DeviceScopeIdentitiesCacheTest
    {
        ...
        static IEntityStore<string, string> GetEntityStore(string entityName)
            => new EntityStore<string, string>(new KeyValueStoreMapper<string, byte[], string, byte[]>(new InMemoryDbStore(string.Empty), new BytesMapper<string>(), new BytesMapper<string>()), entityName);
    }
}
